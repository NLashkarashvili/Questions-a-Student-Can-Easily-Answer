...
for train, test in kfold.split(X):
    ...
    log_output = tf.concat([embedding_chap, embedding_sub_chap, embedding_ques], axis = 2)

    pred = Dense(1, input_shape = (None, 3*EMBEDDING_DIM), activation='sigmoid')(log_output)
